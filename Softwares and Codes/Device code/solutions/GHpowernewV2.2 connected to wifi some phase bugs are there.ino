...
WiFiClient client;
char request_string[]="GET /GHpowermon/action.php/?cur=0.00&cur2=0.00&cur3=0.00&pha=000.0&pha2=000.0&pha3=000.0&vol=000.00&fre=00.0000&ds1=0&ds2=0&ds3=0 HTTP/1.1";
char server_response[255];
                              	 	/**************PORTAL VARIABLE*************/
String ssid=String("raspberry");
String password=String("raspberry");
String client_email;
