...
<a href="index.php"><span style="display:block"><button class="button button1" style="width:500px;margin:20px 60px">START MONITORING</button></span></a>
...
<a href="select.php"><span style="display:block"><button class="button button1" style="width:500px;margin:20px 60px">SCHEDULE ON/OFF</button></span></a>
 </div>
