...
<ul>
 ...
 <span style = "position:absolute;right:5px"> <li><a id="power" href="test.html">LOGIN</a></li><span>
</ul>
<div id="back" >
<b><h2>ABOUT</h2></b>
...
<a href="test.html"><span style="display:block"><button class="button button1" style="width:500px;margin:20px 60px"></button></span></a>
 </div>
