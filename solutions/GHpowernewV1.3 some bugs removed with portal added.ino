...
char server_response[255];
                              	 	/**************PORTAL VARIABLE*************/
String ssid=String("ERTS_LAB_304");
String password=String("balstre403");
String client_email;
	...
	else
    {
		...
		case 1:
			...
			case 4:
				...
				{
					security_start:
					Serial.println("Enter your previous security password>");
					Serial.flush();
					while(Serial.available()==0)
					{};
					incoming=Serial.readString();
					if(incoming==security_key)
					{
						...
						while(Serial.available()==0)
						{};
						Serial.readBytes(security_key,50);
						Serial.print("Congratulation!!! your device has been securied with new password '");
						Serial.print(security_key);
						Serial.println("'");
					}
					else
					{
...
void loop()
{
	if(task_flag==5 && server_flag==1 && powerIN_flag==1)
	{
